...
// function Payment() {
//   // console.log("Payment component is rendered!");
//   // alert("Payment component rendered!");
...
//       // Log the clientSecret received from the backend
...
//         await db
//           .collection("users")
//           .doc(user?.uid) // Ensure the user ID is authenticated
//           .collection("orders")
//           .doc(paymentIntent.id) //paymentIntent.id = orderID
